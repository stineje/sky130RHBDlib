...
.ENDS
***************************************
.SUBCKT XOR2X1 GND VDD A Y B
** N=136 EP=5 IP=0 FDC=18
M0 4 A GND 136 nmos L=0.163346 W=2.31104 $X=775 $Y=830 $D=3
M1 GND A 9 136 nmos L=0.163119 W=2.35104 $X=3060 $Y=790 $D=3
M2 Y B 9 136 nmos L=0.163346 W=2.31104 $X=4030 $Y=830 $D=3
M3 GND 6 11 136 nmos L=0.163119 W=2.35104 $X=6390 $Y=790 $D=3
M4 Y 4 11 136 nmos L=0.163346 W=2.31104 $X=7360 $Y=830 $D=3
...
M10 Y 6 8 134 pmos L=0.15 W=2 AD=0.58 AS=0.58 PD=2.58 PS=2.58 NRD=0 NRS=0 m=1 $X=4035 $Y=5020 $D=27
M11 8 6 Y 134 pmos L=0.15 W=2 AD=0.56 AS=0.56 PD=2.56 PS=2.56 NRD=0 NRS=0 m=1 $X=4475 $Y=5020 $D=27
M12 VDD B 10 134 pmos L=0.15 W=2 AD=0.57 AS=0.57 PD=2.57 PS=2.57 NRD=0 NRS=0 m=1 $X=6485 $Y=5020 $D=27
M13 10 B VDD 134 pmos L=0.15 W=2 AD=0.58 AS=0.58 PD=2.58 PS=2.58 NRD=0 NRS=0 m=1 $X=6925 $Y=5020 $D=27
