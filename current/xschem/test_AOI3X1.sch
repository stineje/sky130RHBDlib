...
"}
C {devices/lab_pin.sym} 220 120 0 1 {name=l4 sig_type=std_logic lab=YN}
...
C {devices/lab_pin.sym} 40 160 0 0 {name=l12 sig_type=std_logic lab=C}
C {AOI3X1.sym} 120 120 0 0 {name=x1 VDD=VDD VSS=GND}
