...
C {TMRDFFRNQNX1.sym} 70 80 0 0 {name=x1 VDD=VDD VSS=GND}
C {devices/gnd.sym} 150 220 0 0 {name=l4 lab=GND}
C {devices/vsource.sym} 150 190 0 0 {name=V6 value="pwl 0n 1.8 82n 1.8 82.1n 0"}
C {devices/lab_pin.sym} 170 130 0 1 {name=l11 sig_type=std_logic lab=RN}
C {devices/lab_pin.sym} 80 150 0 1 {name=l12 sig_type=std_logic lab=RN}
