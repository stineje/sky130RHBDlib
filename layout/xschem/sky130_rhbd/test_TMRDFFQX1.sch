...
C {devices/lab_pin.sym} 10 40 0 0 {name=l1 sig_type=std_logic lab=D0}
C {devices/lab_pin.sym} 10 90 0 0 {name=l2 sig_type=std_logic lab=CLK}
C {devices/lab_pin.sym} 130 50 0 1 {name=l3 sig_type=std_logic lab=Q}
...
C {devices/lab_pin.sym} 10 50 0 0 {name=l9 sig_type=std_logic lab=D1}
C {devices/lab_pin.sym} 10 60 0 0 {name=l10 sig_type=std_logic lab=D2}
C {TMRDFFQX1.sym} 70 70 0 0 {name=x1 VDD=VDD VSS=GND}
