...
/import/programs/cadence/LIBERATE/current/bin/spectre -64 +multiple -cp -ss -l -f nutascii +lqt 0 /import/yukari1/lrburle/sky130RHBDlib/char/liberate/decks.yukari.ecen.okstate.edu.T20260127062336859061S0078025/FA/delay_5/delay_5_001/sim.sp
