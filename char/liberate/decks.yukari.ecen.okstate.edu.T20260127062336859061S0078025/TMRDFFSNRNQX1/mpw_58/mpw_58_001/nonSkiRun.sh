...
/import/programs/cadence/LIBERATE/current/bin/spectre -64 +multiple -cp -ss -l -f nutascii +lqt 0 /import/yukari1/lrburle/sky130RHBDlib/char/liberate/decks.yukari.ecen.okstate.edu.T20260127062336859061S0078025/TMRDFFSNRNQX1/mpw_58/mpw_58_001/sim.sp
