...
Changing to a different library involves changing the following two files:
	1. .synopsys_dc.setup
	2. ./scripts/synth.tcl

Should only have one instance of changing the library name inside the .synopsys_dc.setup file and two for the synth.tcl file. Remember to change the "set 180lib" line to point to the correct directory where the .lib and .db files are.
