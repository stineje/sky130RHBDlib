...
# Executed on 10:50:42 AM(May23) by user: lrburle
...
global env
set env(VPATH) make
set vars(ff_exe_dir) "/import/yukari1/lrburle/sky130RHBDlib/flow/flow/pnr"
set vars(rundir) "/import/yukari1/lrburle/sky130RHBDlib/flow/flow/pnr"
...
set vars(cwd) {/import/yukari1/lrburle/sky130RHBDlib/flow/flow/pnr}
...
set vars(design) {riscvsingle}
set vars(design_root) {/import/yukari1/lrburle/sky130RHBDlib/flow/flow/pnr/../..}
...
set vars(execute_string) {/usr/bin/tclsh /import/yukari1/lrburle/sky130RHBDlib/flow/flow/pnr/SCRIPTS/gen_flow.tcl -m flat -d FF -v 17.1.0 -s . -y none -n signoff}
...
set vars(lef_files) {../../../sky130_rhbd/lef/s130.tlef ../../../sky130_rhbd/lef/sky130_rhbd.lef}
set vars(library_root) {../../../sky130_rhbd}
set vars(library_sets) {libs_tt}
set vars(libs_tt,timing) {../../../sky130_rhbd/lib/sky130_rhbd_tt_1P8_25C.ccs.lib}
...
set vars(mode) {flat}
set vars(netlist) {../../output-files/OSU130_RHBD/riscvsingle//riscvsingle.vh}
...
set vars(plugins_defined) {pre_init_tcl post_init_tcl pre_place_tcl pre_cts_tcl post_cts_tcl post_signoff_tcl}
set vars(plugins_found) {pre_init_tcl post_init_tcl pre_place_tcl pre_cts_tcl post_cts_tcl post_signoff_tcl}
...
set vars(pre_cts_sdc) {/import/yukari1/lrburle/sky130RHBDlib/flow/output-files/OSU130_RHBD/riscvsingle/riscvsingle.sdc}
...
set vars(script_path) {/import/yukari1/lrburle/sky130RHBDlib/flow/flow/pnr/SCRIPTS}
set vars(script_root) {/import/yukari1/lrburle/sky130RHBDlib/flow/flow/pnr/SCRIPTS}
set vars(seed) {1}
...
set vars(setup_func_mode,pre_cts_sdc) {/import/yukari1/lrburle/sky130RHBDlib/flow/output-files/OSU130_RHBD/riscvsingle/riscvsingle.sdc}
set vars(setup_path) {.}
...
set vars(threads) {1}
set vars(tie_cells) {TIELO TIEHI}
set vars(time_info_db) {RPT/time_info.db}
set vars(time_info_rpt) {RPT/time_info.rpt}
set vars(timelib) {}
set vars(timelib,max) {../../../sky130_rhbd/lib/sky130_rhbd_tt_1P8_25C.ccs.lib}
set vars(timelib,min) {../../../sky130_rhbd/lib/sky130_rhbd_tt_1P8_25C.ccs.lib}
set vars(top) {0}
set vars(top_cell) {riscvsingle}
