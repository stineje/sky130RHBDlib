####################################################################
# Innovus Foundation Flow Code Generator, Fri May 23 09:52:51 CDT 2025
...
if {$vars(restore_design)} { restoreDesign DBS/init.enc.dat riscvsingle }
