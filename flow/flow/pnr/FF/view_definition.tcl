...
create_library_set -name libs_tt \
   -timing [list ../../../sky130_rhbd/lib/sky130_rhbd_tt_1P8_25C.ccs.lib]
create_delay_corner -name corner_tt -library_set libs_tt -rc_corner rc_typ
create_constraint_mode -name setup_func_mode \
   -sdc_files [list /import/yukari1/lrburle/sky130RHBDlib/flow/output-files/OSU130_RHBD/riscvsingle/riscvsingle.sdc]
