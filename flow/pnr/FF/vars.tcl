...
# Executed on 09:41:46 AM(Mar20) by user: lrburle
...
global env
set env(VPATH) make
set vars(ff_exe_dir) "/import/yukari1/lrburle/RHBD_SKY130_Zach/pnr"
set vars(rundir) "/import/yukari1/lrburle/RHBD_SKY130_Zach/pnr"
...
set vars(cts_buffer_cells) {BUFX1}
set vars(cts_engine) {ccopt}
set vars(cts_inverter_cells) {INVX1}
set vars(custom_rundir_name_append) {}
set vars(cwd) {/import/yukari1/lrburle/RHBD_SKY130_Zach/pnr}
set vars(data_root) {../outputs_pex/synth/}
...
set vars(design) {fsm}
set vars(design_root) {/import/yukari1/lrburle/RHBD_SKY130_Zach/pnr/../..}
...
set vars(execute_string) {/usr/bin/tclsh /import/yukari1/lrburle/RHBD_SKY130_Zach/pnr/SCRIPTS/gen_flow.tcl -m user -d FF -v 17.1.0 -s . -y none -n signoff}
...
set vars(lef_files) {../outputs_pex/sky130_rhbd//s130.tlef ../outputs_pex/sky130_rhbd//sky130_rhbd.lef}
set vars(library_root) {../outputs_pex/sky130_rhbd/}
set vars(library_sets) {libs_tt}
set vars(libs_tt,timing) {../outputs_pex/sky130_rhbd//TMR_sky130_rhbd_tt_1P8_25C.ccs.lib ../outputs_pex/sky130_rhbd//sky130_rhbd_tt_1P8_25C.ccs.lib}
...
set vars(mode) {user}
set vars(netlist) {../outputs_pex/synth//fsm.vh}
...
set vars(pre_cts_sdc) {/import/yukari1/lrburle/RHBD_SKY130_Zach/outputs_pex/synth/fsm.sdc}
...
set vars(script_path) {/import/yukari1/lrburle/RHBD_SKY130_Zach/pnr/SCRIPTS}
set vars(script_root) {/import/yukari1/lrburle/RHBD_SKY130_Zach/pnr/SCRIPTS}
set vars(seed) {1}
...
set vars(setup_func_mode,pre_cts_sdc) {/import/yukari1/lrburle/RHBD_SKY130_Zach/outputs_pex/synth/fsm.sdc}
set vars(setup_path) {.}
...
set vars(timelib) {}
set vars(timelib,max) {../outputs_pex/sky130_rhbd//TMR_sky130_rhbd_tt_1P8_25C.ccs.lib ../outputs_pex/sky130_rhbd//sky130_rhbd_tt_1P8_25C.ccs.lib}
set vars(timelib,min) {../outputs_pex/sky130_rhbd//TMR_sky130_rhbd_tt_1P8_25C.ccs.lib ../outputs_pex/sky130_rhbd//sky130_rhbd_tt_1P8_25C.ccs.lib}
set vars(top) {0}
set vars(top_cell) {fsm}
set vars(top_level) {fsm}
