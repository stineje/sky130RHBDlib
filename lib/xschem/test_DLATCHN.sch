...
N 60 -100 120 -100 {
lab=D}
N 60 -220 60 -190 { lab=GATE_N}
N 60 -220 130 -220 { lab=GATE_N}
...
C {devices/lab_pin.sym} 130 -220 0 1 {name=l23 sig_type=std_logic lab=GATE_N}
C {devices/lab_pin.sym} 10 60 0 0 {name=l1 sig_type=std_logic lab=D}
C {devices/lab_pin.sym} 10 100 0 0 {name=l2 sig_type=std_logic lab=GATE_N}
C {devices/lab_pin.sym} 130 60 0 1 {name=l3 sig_type=std_logic lab=Q}
C {DLATCHN.sym} 70 80 0 0 {name=x1 VDD=VDD VSS=GND}
