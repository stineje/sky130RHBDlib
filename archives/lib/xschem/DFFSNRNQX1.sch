...
C {devices/ipin.sym} -100 -60 0 0 {name=p2 lab=D}
C {devices/ipin.sym} -100 -40 0 0 {name=p3 lab=CLK}
C {devices/ipin.sym} -100 -20 0 0 {name=p4 lab=SN}
C {devices/ipin.sym} -100 0 0 0 {name=p5 lab=RN}
