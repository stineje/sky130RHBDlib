...
*               DC PARAMETERS 
**************************************************************
+is      = '1.1082e-017*dkisnpnpolyhv' dev/gauss='1.1082e-017*dkisnpnpolyhv*0.003/sqrt(E(*,m))'    rb      = 1400
+re      = 85             irb     = 4.424e-005      rc      = 1.0            rbm     = 400.07        
+bf      = '141.286*dkbfnpnpolyhv' dev/gauss='141.286*dkbfnpnpolyhv*0.05/sqrt(E(*,m))'        nf      = 1.0262306       vaf     = 100             ikf     = 0.00046731    
...
*               DC PARAMETERS 
**************************************************************
+is      = '1.2252871e-016*dkisnpnpolyhv' dev/gauss='1.2252871e-016*dkisnpnpolyhv*0.003*2/sqrt(E(*,m))'  rb      = 1922.4
+re      = 6000           irb     = 0               rc      = 1                rbm     = 46.144        
+bf      = '25*dkbfnpnpolyhv' dev/gauss='25*dkbfnpnpolyhv*0.05/sqrt(E(*,m))'  nf      = 1.0161516       vaf     = 0             ikf     = 100
