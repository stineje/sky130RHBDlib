**
.subckt npnpar1x1 nc nb ne param: m=1
.model  npnpar1x1_mod  npn  level = 1
**************************************************************
*               GENERAL PARAMETERS 
**************************************************************
+tref    = 30            
...
*               DC PARAMETERS 
**************************************************************
+is      = '4.5584e-018*dkisnpn1x1' dev/gauss='4.5584e-018*dkisnpn1x1*0.00473/sqrt(E(*,m))'    subs    = 1               rb      = 602.54          re      = 30            
+irb     = 7.4e+020        rc      = 320.4           rbm     = 0               bf      = '39.28*dkbfnpn1x1' dev/gauss='39.28*dkbfnpn1x1*0.05237/sqrt(E(*,m))'        
...
*               QUASI 
**************************************************************
qinst nc nb ne npnpar1x1_mod m=m
.ends
