...
*               DC PARAMETERS 
**************************************************************
+is      = '7.98e-018*dkisnpn1x2' dev/gauss='7.98e-018*dkisnpn1x2*0.0036/sqrt(E(*,m))'    subs    = 1               rb      = 885.61        
+re      = 15.0            irb     = 4.424e-005       rc      = 61.677          rbm     = 256.08        
+bf      = '37.54*dkbfnpn1x2'  dev/gauss='37.54*dkbfnpn1x2*0.0465/sqrt(E(*,m))'       nf      = 1.0405          vaf     = 100             ikf     = 0.0011462
